...
public class Primitive extends Procedure {
  ...
  public Object apply(Object[] args) {
    ...
    case 188 /* string->expr */: return (x==null)?null:((Pair)REPL.parseScheme((String)x)).first;
    case 189 /* string->exprlist */: return (x==null)?null:REPL.parseScheme((String) x);
