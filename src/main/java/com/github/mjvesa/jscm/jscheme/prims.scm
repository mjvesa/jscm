...
(define eval 
 ((lambda(js)
  ...
  (com.github.mjvesa.jscm.jsint.Scheme.currentEvaluator)
 )
)
...
(define-macro (let* bindings . body )
     (if (null? bindings) (com.github.mjvesa.jscm.jsint.Scheme.toBody body)
...
(define-macro (letrec bindings . body)
    ...
    `(let ,(map (lambda (var) `(,var #f)) vars)
       ...
       ,(com.github.mjvesa.jscm.jsint.Scheme.toBody body))))
...
(define vector-fill! com.github.mjvesa.jscm.jsint.U.vectorFill)
